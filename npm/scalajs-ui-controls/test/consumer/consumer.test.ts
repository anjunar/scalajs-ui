...
describe("typechecking a consumer", () => {
  it("resolves all three packages under --strict", () => {
    ...
    const source = [
      ...
      'import { carousel, column, dataGrid, remoteSource, tab, tableView, tabs, virtualList } from "@anjunar/scalajs-ui-controls";',
      'import type { ColumnDef, RemoteSource, TableSort, TableViewHandle, TableViewOptions, TableRowContext, TableSelectionMode } from "@anjunar/scalajs-ui-controls";',
      "",
